...
public class RosterClient {
    ...
    private void insertInfo() {
        ...
        try {
            ...
            request.createMatchWithExistingTeams(new MatchDetails(1, 1, 1), "T1", "T2");
            request.createMatchWithExistingTeams(new MatchDetails(2, 3, 0), "T2", "T3");
            request.createMatchWithExistingTeams(new MatchDetails(3, 3, 0), "T1", "T3");
            request.createMatchWithExistingTeams(new MatchDetails(4, 1, 1), "T5", "T4");
            request.createMatchWithExistingTeams(new MatchDetails(5, 3, 0), "T2", "T4");
            request.createMatchWithExistingTeams(new MatchDetails(6, 1, 1), "T5", "T4");
            request.createMatchWithExistingTeams(new MatchDetails(7, 1, 1), "T2", "T2");
            request.createMatchWithExistingTeams(new MatchDetails(8, 3, 0), "T6", "T1");
            request.createMatchWithExistingTeams(new MatchDetails(9, 3, 0), "T6", "T4");
    ...
    private void getMoreInfo() {
        ...
        try {
            ...
            matchDetails = request.getAllMatches();
            printDetailsList(matchDetails);
            System.out.println("");

            System.out.println("All Teams");
            teamList = request.getAllTeams();
            printDetailsList(teamList);
            System.out.println("");

            System.out.println("All teams by Score");
            teamList = request.getAllTeamsOrderedByScore();
            printDetailsList(teamList);
            System.out.println("");
            ...
            System.out.println("List all teams in league L1 by score:");
            teamList = request.getTeamsInLeagueByScore("L1");
            printDetailsList(teamList);
            System.out.println("");
